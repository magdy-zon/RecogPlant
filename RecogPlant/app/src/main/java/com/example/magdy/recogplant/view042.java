...
public class view042 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view042);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, view043.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view044.class);
                startActivity(abrir);
                break;
        }
