...
public class view052 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view052);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, view053.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view056.class);
                startActivity(abrir);
                break;
        }
