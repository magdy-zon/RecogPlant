...
public class view081 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view081);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, view082.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view083.class);
                startActivity(abrir);
                break;
        }
