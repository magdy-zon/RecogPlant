...
public class view064 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view064);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf061_5.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view065.class);
                startActivity(abrir);
                break;
        }
