...
public class view013 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view013);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, view014.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view016.class);
                startActivity(abrir);
                break;
        }
