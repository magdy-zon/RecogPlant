...
public class view031 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view031);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf028.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, viewf029.class);
                startActivity(abrir);
                break;
        }
