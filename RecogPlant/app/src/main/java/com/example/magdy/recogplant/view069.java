...
public class view069 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view069);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf065_5.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, viewf066.class);
                startActivity(abrir);
                break;
        }
