...
public class view061 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view061);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf059.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view062.class);
                startActivity(abrir);
                break;
        }
