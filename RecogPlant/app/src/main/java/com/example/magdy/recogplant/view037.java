...
public class view037 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view037);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf036.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view038.class);
                startActivity(abrir);
                break;
        }
