...
public class view065 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view065);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf062.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view066.class);
                startActivity(abrir);
                break;
        }
