...
public class view016 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view016);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf016.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view017.class);
                startActivity(abrir);
                break;
        }
