...
public class view008 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view008);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf007.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, viewf008.class);
                startActivity(abrir);
                break;
        }
