...
public class view055 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view055);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf052.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, viewf053.class);
                startActivity(abrir);
                break;
        }
