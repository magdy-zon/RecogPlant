...
public class view079 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view079);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, view080.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view081.class);
                startActivity(abrir);
                break;
        }
