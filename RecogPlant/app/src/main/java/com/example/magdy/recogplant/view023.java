...
public class view023 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view023);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, view024.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view025.class);
                startActivity(abrir);
                break;
        }
