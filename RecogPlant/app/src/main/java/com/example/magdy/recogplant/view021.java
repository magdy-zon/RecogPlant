...
public class view021 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view021);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf019.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, viewf020.class);
                startActivity(abrir);
                break;
        }
