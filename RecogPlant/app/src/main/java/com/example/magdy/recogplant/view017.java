...
public class view017 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view017);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, view018.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view023.class);
                startActivity(abrir);
                break;
        }
