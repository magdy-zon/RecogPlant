...
public class view077 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view077);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf072.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view078.class);
                startActivity(abrir);
                break;
        }
