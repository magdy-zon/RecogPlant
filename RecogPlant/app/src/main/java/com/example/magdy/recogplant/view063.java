...
public class view063 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view063);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf061.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view064.class);
                startActivity(abrir);
                break;
        }
