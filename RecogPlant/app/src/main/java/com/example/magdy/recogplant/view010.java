...
public class view010 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view010);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf009.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view011.class);
                startActivity(abrir);
                break;
        }
