...
public class view032 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view032);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, view033.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view036.class);
                startActivity(abrir);
                break;
        }
