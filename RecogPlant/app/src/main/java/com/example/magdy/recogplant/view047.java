...
public class view047 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view047);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf045.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view048.class);
                startActivity(abrir);
                break;
        }
