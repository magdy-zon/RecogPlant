...
public class view056 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view056);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, view057.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, view061.class);
                startActivity(abrir);
                break;
        }
