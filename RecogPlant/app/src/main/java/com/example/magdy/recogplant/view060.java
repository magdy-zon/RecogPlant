...
public class view060 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view060);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf057.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, viewf058.class);
                startActivity(abrir);
                break;
        }
