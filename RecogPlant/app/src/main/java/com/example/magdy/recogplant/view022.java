...
public class view022 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view022);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf021.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, viewf022.class);
                startActivity(abrir);
                break;
        }
