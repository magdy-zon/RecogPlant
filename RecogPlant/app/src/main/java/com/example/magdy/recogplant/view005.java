...
public class view005 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view005);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf003.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, viewf004.class);
                startActivity(abrir);
                break;
        }
