...
public class view011 extends Activity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view011);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.op1:
                abrir = new Intent(this, viewf010.class);
                startActivity(abrir);
                break;

            case R.id.op2:
                abrir = new Intent(this, viewf011.class);
                startActivity(abrir);
                break;
        }
